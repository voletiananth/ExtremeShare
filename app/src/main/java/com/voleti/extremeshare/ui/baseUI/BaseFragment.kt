...
open class BaseFragment(private val config:BaseConfig<BaseModelImpl>):Fragment() {
    ...
    private fun initComponents(){
        ...
        baseRecycleView.layoutManager = config.mainLayoutManager(context)
         class MyHolder(val viewBinding: ViewBinding):RecyclerView.ViewHolder(viewBinding.root)
    ...
    open fun bind(viewBinding: ViewBinding,position: Int)  = config.mainBind(viewBinding, position)
